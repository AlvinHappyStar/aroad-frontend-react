            ...
            <Grid container spacing={4}
                ...
                <Grid item xs={windowWidth > SCREEN_SMALL_WIDTH ? 3 : 12}>
                    {
                        ...
                        <H5_Desktop style={{
                            ...
                            textAlign: 'center',
                        }}>Porvisional License</H5_Desktop>
                    }
                    {
                        windowWidth <= SCREEN_SMALL_WIDTH &&
                        <H5_Mobile style={{
                            textAlign: 'center',
                        }}>Porvisional License</H5_Mobile>
                    }
                    <Box sx={{
                        ...DISPLAY_FLEX_ROW,
                        ...{
                ...
                <Grid item xs={windowWidth > SCREEN_SMALL_WIDTH ? 3 : 12}>
                {
                        ...
                        <H5_Desktop style={{
                            ...
                            textAlign: 'center',
                        }}>Theory Training?</H5_Desktop>
                    }
                    {
                        windowWidth <= SCREEN_SMALL_WIDTH &&
                        <H5_Mobile style={{
                            textAlign: 'center',
                        }}>Theory Training?</H5_Mobile>
                    }
                    <Box sx={{
                        ...DISPLAY_FLEX_ROW,
                        ...{
                ...
                <Grid item xs={windowWidth > SCREEN_SMALL_WIDTH ? 3 : 12}>
                {
                        ...
                        <H5_Desktop style={{
                            ...
                            textAlign: 'center',
                        }}>CPC Training</H5_Desktop>
                    }
                    {
                        windowWidth <= SCREEN_SMALL_WIDTH &&
                        <H5_Mobile style={{
                            textAlign: 'center',
                        }}>CPC Training</H5_Mobile>
                    }
                    <Box sx={{
                        ...DISPLAY_FLEX_ROW,
                        ...{
                ...
                <Grid item xs={windowWidth > SCREEN_SMALL_WIDTH ? 3 : 12}>
                {
                        ...
                        <H5_Desktop style={{
                            ...
                            textAlign: 'center',
                        }}>Passed Theory?</H5_Desktop>
                    }
                    {
                        windowWidth <= SCREEN_SMALL_WIDTH &&
                        <H5_Mobile style={{
                            textAlign: 'center',
                        }}>Passed Theory?</H5_Mobile>
                    }
                    <Box sx={{
                        ...DISPLAY_FLEX_ROW,
                        ...{
